    ...
    <div class="d-flex justify-content-around mt-5 text-center">
        ...
        <div class="flex-shrink-0 p-3 bg-white ml-5 pl-5" style="width: 25%;">
            ...
            <ul class="list-unstyled ps-0">
                <li class="mb-1">
                    <button class="btn btn-block btn-outline-primary rounded collapsed" data-bs-toggle="collapse" data-bs-target="#news-collapse">
                        News
                    </button>
                ...
                <li class="mb-1">
                    <button class="btn btn-block btn-outline-primary align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#instructors-collapse" aria-expanded="false">
                        Instructors
                    </button>
                ...
                <li class="mb-1">
                    <button class="btn btn-block btn-outline-primary align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#students-collapse" aria-expanded="false">
                        Students
                    </button>
                ...
                <li class="mb-1">
                    <button class="btn btn-block btn-outline-primary align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#courses-collapse" aria-expanded="false">
                        Courses
                    </button>
                ...
                <li class="mb-1">
                    <a href="/team2/FAQ/listquestions.php" class="btn btn-block btn-outline-primary align-items-center rounded collapsed">
                        List Questions</a>

                </li>
                <li class="mb-1">
                    <a href="/team2/feedback/list_feed.php" class="btn btn-block btn-outline-primary align-items-center rounded collapsed">
                        List Feedbacks</a>
                </li>
